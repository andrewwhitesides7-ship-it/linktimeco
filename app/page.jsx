        ...
        <section className="hero wrap">
          <div>
            ...
            <p className="hero-sub">
              The Dimple Dial is cut by hand from a genuine golf ball and
          ...
          <div className="wrap center">
            ...
            <div className="features">
              ...
              <Reveal className="feature d3">
                ...
                <h3>Hand-built</h3>
                <p>
                  Assembled one at a time, by hand, with a photo of your
          ...
          <div className="wrap">
            ...
            <div className="steps">
              <Reveal className="step d1">
                ...
                <h3>You order</h3>
                <p>
                  Checkout takes a minute. You get a confirmation the same
                  day with everything that happens next.
                </p>
              </Reveal>
              <Reveal className="step d2">
                ...
                <h3>We build</h3>
                <p>
                  Your ball is cut, trued, and cased by hand, with a photo
                  of the finished watch before it ships.
                </p>
              </Reveal>
          ...
          <div className="wrap-narrow">
            ...
            <div style={{ marginTop: "32px" }}>
              <details className="faq-item">
                <summary>How long until it&apos;s on my wrist?</summary>
                <p>
                  About two weeks from order to wrist. Each watch is built by
                  hand when you order it, and cutting and seating a real golf
                  ball into a watch case is slow, careful work. For custom
                  ball builds, the two weeks starts the day your ball lands
                  on the bench.
                </p>
              </details>
              <details className="faq-item">
              ...
              <details className="faq-item">
                ...
                <p>
                  ...
                  custom option at checkout and we&apos;ll email you a
